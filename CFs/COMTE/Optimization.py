...
class BaseExplanation:
    def __init__(
        ...
        train_y,pred_y = labels
        self.clf = clf
        self.timeseries = timeseries
        self.labels = pd.DataFrame(train_y, columns=["label"])
        self.preds = pred_y
        self.silent = silent
...
class BruteForceSearch(BaseExplanation):
    def __init__(
        ...
        super().__init__(clf, timeseries, labels,silent,num_distractors,False,threads)
...
class OptimizedSearch(BaseExplanation):
    def __init__(
        ...
        self.backup = BruteForceSearch(clf, timeseries, labels,silent,threads=threads,num_distractors=num_distractors)
