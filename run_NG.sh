...
python CF_generate.py  --CF_name NG --model_name InceptionTime --dataset_choice multiclass_uni --CUDA cuda:3 --start_per 0.0 --end_per 0.125 &
python CF_generate.py  --CF_name NG --model_name InceptionTime --dataset_choice multiclass_uni --CUDA cuda:3 --start_per 0.125 --end_per 0.25 &
python CF_generate.py  --CF_name NG --model_name InceptionTime --dataset_choice multiclass_uni --CUDA cuda:3 --start_per 0.25 --end_per 0.375 &
python CF_generate.py  --CF_name NG --model_name InceptionTime --dataset_choice multiclass_uni --CUDA cuda:3 --start_per 0.375 --end_per 0.50 &
...
python CF_generate.py  --CF_name NG --model_name FCN --dataset_choice selected_uni --CUDA cuda:3 --start_per 0.0 --end_per 1.0
wait